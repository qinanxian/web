...
(function (root, undefined) {
    ...
    function checkCurrencyFormat(format) {
        let defaults = lib.settings.currency.format;
     ...
     */
    let toFixed = lib.toFixed = function (value, precision) {
        ...
        let opts = defaults(
            ...
            formatted = map(list, (val, i) => {
                if (isArray(val)) {
                    ...
                    let useFormat = val > 0 ? formats.pos : val < 0 ? formats.neg : formats.zero,
