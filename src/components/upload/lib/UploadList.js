...
import {default as RoIcon} from '../../icon';
import Tooltip from '../../../../node_modules/antd/es/tooltip';
import Progress from '../../../../node_modules/antd/es/progress';
    ...
    _createClass(UploadList, [{
        ...
        value: function render() {
            ...
            var list = items.map(function (file) {
                ...
                var infoUploadingClass = classNames((_classNames = {}, _defineProperty(_classNames, prefixCls + '-list-item', true), _defineProperty(_classNames, prefixCls + '-list-item-' + file.status, true),_defineProperty(_classNames, file.status === 'done' ? prefixCls + '-list-item-canremove' : '', true), _classNames));
                ...
                var previewIcon = showPreviewIcon ? React.createElement(
                    ...
                    React.createElement(RoIcon, { type: 'eyeo',className: 'ro-preview' },)
                ) : null;
                var removeIcon = showRemoveIcon ? React.createElement(RoIcon, { className: 'ro-replace',type: 'roic-replace', title: '更新', onClick: function onClick() {
