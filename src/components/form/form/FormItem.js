...
var _intersperse2 = function intersperse(arr, obj) {
...
var _row = require('antd/lib/grid/row');

var _row2 = _interopRequireDefault(_row);

var _col = require('antd/lib/grid/col');

var _col2 = _interopRequireDefault(_col);

var _warning = require('antd/lib/_util/warning');
    ...
    (0, _createClass3['default'])(FormItem, [{
        ...
        value: function getHelpMessage() {
            ...
            if (help === undefined && this.getOnlyControl()) {
                ...
                if (errors) {
                    return (0, _intersperse2)(errors.map(function (e, index) {
        ...
        value: function renderLabel() {
            var _props3 = this.props,
                ...
                colon = _props3.colon,
                id = _props3.id,
                hiddenLabel = _props3.hiddenLabel;
            ...
            return (label && !hiddenLabel) ? React.createElement(
                _col2['default'],
                (0, _extends3['default'])({}, labelCol,
                  { className: labelColClassName,
                    key: 'label',
                    style: {
                      width: _props3.labelWidth,
                      minWidth: _props3.labelWidth,
                  }}),
                React.createElement(
                    'label',
