...
@propsCompose
export default class GCGroupChart extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            time_arr2:[0,0,0,0,0],
            data: [
                { name:'垃圾回收次数', t1: 0, t2: 0, t3 :0, t4: 0, t5: 0 },
                { name:'标记-清除算法的次数', t1: 0, t2: 0, t3:0, t4: 0, t5: 0},
                { name:'垃圾回收消耗时间', t1: 0, t2: 0, t3:0, t4: 0, t5: 0},
                { name:'标记-清除算法的消耗时间', t1: 0, t2: 0, t3:0, t4: 0, t5: 0}
              ],
            dv:null
          }
    }
    ...
    getData = () =>{
        if(this.flag){
            ...
            rest.get('/metrics').then((data)=>{
                ...
                this.state.count_arr1.unshift(data['gc.ps_scavenge.count']);
                this.state.count_arr2.pop();
                this.state.count_arr2.unshift(data['gc.ps_marksweep.count']);
                this.state.time_arr1.pop();
                this.state.time_arr1.unshift(data['gc.ps_scavenge.time']);
                this.state.time_arr2.pop();
                this.state.time_arr2.unshift(data['gc.ps_marksweep.time']);
                this.dataProcess();
            });
