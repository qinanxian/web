...
@propsCompose
export default class HeapGroupChart extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            time_arr2:[0,0,0,0,0],
            data: [
                { name:'heap.committed', t1: 0, t2: 0, t3 :0, t4: 0, t5: 0 },
                { name:'heap.init', t1: 0, t2: 0, t3:0, t4: 0, t5: 0},
                { name:'heap.used', t1: 0, t2: 0, t3:0, t4: 0, t5: 0},
                { name:'heap', t1: 0, t2: 0, t3:0, t4: 0, t5: 0}
              ],
            dv:null
          }
    }
    ...
    getData = () =>{
        if(this.flag){
            ...
            rest.get('/metrics').then((data)=>{
                ...
                this.state.count_arr1.unshift(data['heap.committed']);
                this.state.count_arr2.pop();
                this.state.count_arr2.unshift(data['heap.init']);
                this.state.time_arr1.pop();
                this.state.time_arr1.unshift(data['heap.used']);
                this.state.time_arr2.pop();
                this.state.time_arr2.unshift(data['heap']);
                this.dataProcess();
            });
